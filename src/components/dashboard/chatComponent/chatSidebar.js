...
class ChatSidebar extends React.Component {
    ...
    constructor(props) {
        ...
        this.formatChatItems = this.formatChatItems.bind(this);
    ...
    formatChatItems() {
        ...
        let formattedItems = Object.values(this.props.chats).map(chat => {
            return {
                avatar: Avatar,
                ...
                <Col style={{ padding: "0px" }}>
                    ...
                    <Row>
                        ...
                        <Container style={{ paddingBottom: "1rem" }}>
                            <Col>
                                <Row style={{ padding: "0rem 1rem 0.5rem" }}>
                                        <Button
                                            variant="outline-success"
                                            block
                                            onClick={this.showAddChatForm}
                                        >
                                            Add Chat
                                        </Button>
                                </Row>
                                <Row style={{ padding: "0rem 1rem 0rem" }}>
